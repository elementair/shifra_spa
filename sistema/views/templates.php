...
class templates{
    ...
    public function acciones($tabla){
        $modifica = array('grupo','seccion_menu','accion','menu','usuario',
            'video_index', 'elemento_lista','fondo_index','grupo_producto','producto','imagen_producto', 'cliente',
            'alianza', 'ficha_tecnica_producto','ases_campo','alianzas_comerciales','nuestros_clientes',
            'quienes_somos','nosotros_tema','nosotros','contacto','sub_producto','servicios','instalaciones','promociones');


        $desactiva_bd = array('grupo','seccion_menu','accion','menu','usuario',
            'video_index', 'elemento_lista','fondo_index','grupo_producto', 'producto','imagen_producto', 'cliente',
            'alianza', 'ficha_tecnica_producto','ases_campo','alianzas_comerciales','nuestros_clientes',
            'quienes_somos','nosotros_tema','nosotros','sub_producto','contacto','servicios','instalaciones','promociones');
        ...
        $elimina_bd = array('grupo','seccion_menu','accion','menu','usuario',
            'video_index', 'elemento_lista','fondo_index','grupo_producto', 'producto','imagen_producto', 'cliente',
            'alianza', 'ficha_tecnica_producto','ases_campo','alianzas_comerciales','nuestros_clientes','quienes_somos',
            'nosotros_tema','nosotros','sub_producto','contacto','servicios','instalaciones','promociones');
    ...
    public function obten_elementos_body($tabla, $registro){
        ...
        foreach($this->campos as $campo){
            ...
            $tipo = false;
            if($campo == 'video_index_archivo'){
                $tipo = 'video';
            }
            elseif ($campo == 'fondo_index_archivo'){
                $tipo = 'imagen';
            }
            elseif ($campo == 'ases_campo'){
                $tipo = 'imagen';
            }
            elseif ($campo == 'alianzas_comerciales'){
                $tipo = 'imagen';
            }
            elseif ($campo == 'nuestros_clientes'){
                $tipo = 'imagen';
            }
            elseif ($campo == 'producto_encabezado'){
                $tipo = 'imagen';
            }
            elseif ($campo == 'contacto'){
                $tipo = 'imagen';
            }
